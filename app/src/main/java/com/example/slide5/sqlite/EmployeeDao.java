package com.example.slide5.sqlite;
...
public class EmployeeDao {
    ...
    @SuppressLint("Range")
    public List<Employee> get(String sql, String ...selectAgrs){
    ...
    public Employee getById(String id){
        String sql = "SELECT * FROM nhanvien WHEN id = ?";
    ...
    public long update(Employee emp){
        ...
        return db.update("nhanvien",null, "id = ?", new String[]{emp.getId()});
    }
